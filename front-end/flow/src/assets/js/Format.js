...
Format.prototype.refresh = function()
{
  ...
  else
  {
    ...
    else
    {
      ...
      this.panels.push(new ActionFormatPanel(this, ui, actionPanel));
 ...
 * Adds the label menu items to the given menu and parent.
 */
ActionFormatPanel = function(format, editorUi, container)
{
  BaseFormatPanel.call(this, format, editorUi, container);
  this.init();
};

mxUtils.extend(ActionFormatPanel, BaseFormatPanel);

/**
 * Adds the label menu items to the given menu and parent.
 */
ActionFormatPanel.prototype.init = function() {
  var ui = this.editorUi;
  var editor = ui.editor;
  var graph = editor.graph;
  var ss = this.format.getSelectionState();
...
ActionFormatPanel.prototype.addAssignment24HoursAlertAct = function(container)
{
  ...
  this.createButtonElement(container, 'OK', 'addAssignment24HoursAlertSubmit', data);
...
ActionFormatPanel.prototype.addAnouncementAct = function(container)
{
  ...
  this.createButtonElement(container, 'OK', 'addAnouncementSubmit', data);
...
ActionFormatPanel.prototype.addAssignment60MinutesAlertAct = function(container)
{
  ...
  this.createButtonElement(container, 'OK', 'assignment60MinutesAlertSubmit', data);
...
ActionFormatPanel.prototype.addAssignment10MinutesAlertAct = function(container)
{
  ...
  this.createButtonElement(container, 'OK', 'addAssignment10MinutesAlertActSubmit', data);
...
ActionFormatPanel.prototype.addAssignmentHalfTimeAlertAct = function(container)
{
  ...
  this.createButtonElement(container, 'OK', 'assignmentHalfTimeAlertSubmit', data);
...
ActionFormatPanel.prototype.addSMSAct = function(container)
{
  ...
  this.createButtonElement(container, 'OK', 'smsSubmit', data);
...
ActionFormatPanel.prototype.createButtonElement = function(container, text, functionName, data){
  ...
  let node = this.editorUi.editor.graph.getSelectionCells()[0];
...
ActionFormatPanel.prototype.addEmailAct = function(container)
{
  ...
  this.createButtonElement(container, 'OK', 'emailSubmit', data);
...
ActionFormatPanel.prototype.addReceptionTimeAct = function(container)
{
  ...
  this.createButtonElement(container, 'OK', 'receptionTimeActSubmit', data);
...
ActionFormatPanel.prototype.addHomeworkCheckedAct = function(container)
{
  ...
  this.createButtonElement(container, 'OK', 'homeworkCheckedActSubmit', data);
...
ActionFormatPanel.prototype.addExamCheckedAct = function(container)
{
  ...
  this.createButtonElement(container, 'OK', 'examCheckedActSubmit', data);
...
ActionFormatPanel.prototype.addFileUploadAct = function(container)
{
  ...
  this.createButtonElement(container, 'OK', 'fileUploadActSubmit', data);
...
ActionFormatPanel.prototype.addVideoUploadAct = function(container)
{
  ...
  this.createButtonElement(container, 'OK', 'videoUploadActSubmit', data);
...
ActionFormatPanel.prototype.addNewAssignmentAct = function(container)
{
  ...
  this.createButtonElement(container, 'OK', 'sendWeeklyTaskActSubmit', data);
...
ActionFormatPanel.prototype.addReachedDateAct = function(container)
{
  ...
  this.createButtonElement(container, 'OK', 'reachedDateSubmit', data);
...
ActionFormatPanel.prototype.addForumMessageAct = function(container)
{
  ...
  this.createButtonElement(container, 'OK', 'forumMessageSubmit', data);
